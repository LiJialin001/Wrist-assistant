...
#define LV_FS_SEEK_SET1  SEEK_SET//这里原本是:LV_FS_SEEK_SET  SEEK_SET
#endif
 ...
 */
#define LV_FONT_CUSTOM_DECLARE  LV_FONT_DECLARE(font_cn_40)
...
#define LV_THEME_DEFAULT_COLOR_PRIMARY      lv_color_make(86, 94, 102) // lv_color_hex(0x383838)//lv_color_hex(0x01a2b1)  // LV_COLOR_BLUE
#define LV_THEME_DEFAULT_COLOR_SECONDARY    lv_color_hex(0xf0f3fd)  // LV_COLOR_RED
